...
gulp.task("serve", function () {
  ...
  gulp.watch("./src/images/*").on("add", series("images"));
...
gulp.task("build", series("svgstore", "less", "html", "images"));

gulp.task("default", series("svgstore", parallel("html", "less", "images"), "serve"));
